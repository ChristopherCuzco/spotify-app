...
function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-zinc-900 to-black text-white px-4 py-8">
      {artist && (
        <div className="flex flex-col items-center justify-center mb-8 sm:mb-12">
          <img
            className="rounded-full h-48 w-48 sm:h-64 sm:w-64 border-4 border-zinc-800 shadow-2xl mb-4 sm:mb-6"
          ...
          <button
            onClick={handleLogin}
            className="px-6 sm:px-8 py-2 sm:py-3 bg-green-500/90 text-white rounded-full hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-green-500/25 font-medium flex items-center gap-2 text-sm sm:text-base"
          >
